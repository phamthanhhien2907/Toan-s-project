                  ...
                  <div className="p-4">
                    <div className="flex  items-center justify-center">
                      <img
                        src="https://shopfront-cdn.tekoapis.com/static/empty_cart.png"
                        alt=""
                        className="flex w-[460px] h-[460px] items-center justify-center"
                      />
                    </div>
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <button
                        className="bg-blue-900 py-1 px-2 border rounded-md"
                        onClick={() => navigate("/")}
                      >
                        <span className="text-white text-xs">Mua sắm ngay</span>
                      </button>
                    </div>
                  </div>
                </div>
