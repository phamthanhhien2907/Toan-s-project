...
const Products = ({ product, category }) => {
  ...
  return (
    <>
      <div className="w-full flex-col flex bg-gray-200 rounded-xl p-4">
        <h3 className="py-4 font-medium  text-xl text-black">
          ĐIỆN MÁY - DA DỤNG
        </h3>
      ...
      <div className="w-full mb-4 rounded-xl bg-gray-200 p-4">
        <h3 className="py-4 font-medium text-xl text-black">LAPTOP</h3>
        <div className="flex gap-2 ">
      ...
      <div className="w-full mb-4 rounded-xl bg-gray-200 p-4">
        <h3 className="py-4 font-medium text-xl text-black">LINH KIỆN</h3>
        <div className="flex gap-2 ">
