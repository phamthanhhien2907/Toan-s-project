    ...
    <div className={hidden ? "hidden" : " gap-12 py-4  bg-white flex w-full"}>
      <div className="flex px-4  flex-col flex-1 items-start justify-start gap-4">
        ...
        <div className="flex flex-col text-xs gap-2 text-gray-600">
          ...
          <span>Hỗ trợ khách hàng: hotro@phongvu.vn</span>
          <span>Báo lỗi bảo mật: security@phongvu.vn</span>
        </div>
      </div>
      <div className="flex flex-col flex-1 items-start justify-start gap-4">
        <h3 className="text-base font-medium">Về Phong Vũ</h3>
        <div className="flex flex-col text-xs gap-2 text-gray-600">
          <span>Giới thiệu Phong Vũ</span>

          <span>Phong Vũ Blog</span>
          ...
          <span>Giới thiệu Phong Vũ Xu</span>
          <span>Gói hội viên VIP</span>
          <span>Tiếp thị liên kết cùng Phong Vũ</span>
      ...
      <div className="flex flex-col flex-1 items-start justify-start gap-4">
        ...
        <div className="flex flex-col text-xs gap-2 text-gray-600">
          ...
          <span>Bán hàng cùng Phong Vũ</span>
        </div>
        <div>
